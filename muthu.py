...
client = pymongo.MongoClient('mongodb+srv://swethashruthi05:shruthi05@cluster0.ms1ivux.mongodb.net/?retryWrites=true&w=majority')
...
api_key = "AIzaSyCVAgrvQwwJc5slYBwKv_mRqEypTWKpA5w"
...
if selected == "Home":
    ...
    st.markdown("## :pink[Technologies used] : Python,MongoDB, Youtube Data API, MySql, Streamlit")
    st.markdown(
        "## :purple[Overview] : Retrieving the Youtube channels data from the Google API, storing it in a MongoDB as data lake, migrating and transforming data into a SQL database,then querying the data and displaying it in the Streamlit app.")
...
if selected == "Get Data & Transform":
    ...
    with tab2:
        ...
        user_inp = st.selectbox("Selection option", options=ch_names)
